...
extern void *mono_aot_module_aqq_iOS_info;
...
extern void *mono_aot_module_aqq_info;
...
{
	mono_aot_register_module (mono_aot_module_aqq_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_aqq_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "aqq.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;

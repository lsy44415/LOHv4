...
namespace aqq
{
    ...
    {     
        ...
        {   
            ...
            // backgroundJob.Source = ImageSource.FromResource("aqq.Image.bg1.jpg");
            gridlayout = new Grid{};
            Content = gridlayout;

			var image1 = new Image
			{
				Source = ImageSource.FromResource("aqq.Image.bg1.jpg"),
				Aspect = Aspect.AspectFill,
				Opacity = 0.7
			};

            ScrollView scroll = new ScrollView{};
			Grid.SetRowSpan(image1, 1);
			Grid.SetColumnSpan(image1, 1);
			gridlayout.Children.Add(scroll, 0, 0);
